...
export default async function SignInPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#1e1e2e]">
      <div className="w-full max-w-sm rounded-lg border border-[#45475a] bg-[#313244] p-8 text-center">
        ...
        >
          <button
            type="submit"
            className="flex w-full items-center justify-center gap-3 rounded-md bg-[#cdd6f4] px-4 py-3 text-sm font-medium text-[#1e1e2e] transition-colors hover:bg-[#cdd6f4]/90"
          >
